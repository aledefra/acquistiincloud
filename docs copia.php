...
<head>
    ...
    <link rel="stylesheet" media="all" href="/assets/application-a3deff8052f6f9f734267f0e57b70d73.css" data-turbolinks-track="true" />
    <script src="/assets/application-cc243a407e58306aacbddb2e2bbc3036.js" data-turbolinks-track="true"></script>
    <script src="//www.google.com/jsapi"></script>
    <script src="/assets/chartkick-7e8cf87dd54b8619d5c358667c21be0c.js"></script>
    ...
    <!--[if lte IE 9]>
	  <link rel="stylesheet" href="/vendor/assets/stylesheets/ace-part2.min.css" />
  <![endif]-->

    <!--[if lte IE 9]>
    <link rel="stylesheet" href="/vendor/assets/stylesheets/ace-ie.min.css" />
  <![endif]-->

    <!-- FAVICON -->
    <link rel="icon" type="image/png" href="/vendor/assets/images/favicon.png">

    <!-- inline styles related to this page -->

    <!-- ace settings handler -->
    <script src="/vendor/assets/javascripts/ace-extra.min.js"></script>

    <!-- HTML5shiv and Respond.js for IE8 to support HTML5 elements and media queries -->

    <!--[if lte IE 8]>
  <script src="/vendor/assets/javascripts/html5shiv.min.js"></script>
  <script src="/vendor/assets/javascripts/respond.min.js"></script>
  <![endif]-->
    <meta name="csrf-param" content="authenticity_token" />
    <meta name="csrf-token" content="4LekdpVNGzAiL1UbLwejl6kbmZ7WFi11v4ix82zxs1XqpeQ1ys1K2UVTQFtoLf1CjpMDCGv0WvQGnCR9FcKBAQ==" />
</head>
...
<option value="160">Pubblicità</option></select></div>
    ...
    <a remote="true">1</a>
          ...
          <li>
    <a rel="next" data-remote="true" href="/consultant/docs?page=2">2</a>
  </li>

          <li>
    <a data-remote="true" href="/consultant/docs?page=3">3</a>
  </li>

          <li>
    <a data-remote="true" href="/consultant/docs?page=4">4</a>
  </li>

          <li>
    <a data-remote="true" href="/consultant/docs?page=5">5</a>
  </li>
  ...
  <a>...</a>
    ...
    <li>
  <a rel="next" data-remote="true" href="/consultant/docs?page=2">Succ &rsaquo;</a>
</li>

    <li>
  <a data-remote="true" href="/consultant/docs?page=3299">Ultima &raquo;</a>
</li>

  </ul>

    <div class="pagination per-page pull-right">
      <form action="/consultant/docs?page=1" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="oRzBD++RoKg73K0GWGJtnljgeYioQTam7zuGxwXa5EOrDoFMsBHxQVyguEYfSDNLf2jjHhWjQSdWLxNJfOnWFw==" /><label for="consultant_docs_limit">Per pagina</label><select name="consultant_docs_limit" id="consultant_docs_limit" data-remote="true" data-url="/consultant/docs?page=1"><option value="10">10</option>
<option value="25">25</option>
<option value="50">50</option>
<option value="100">100</option></select></form>
    </div>
  </div>-->
    ...
    <div class="modal fade" id="ajax-modal-large">
...
<script type="text/javascript">
    $(this).ready(function() {
        ...
        $("#button-actions").on("click", function() {
            $("#button-actions-menu").show(250);
        });
